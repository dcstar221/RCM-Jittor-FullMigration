import jittor as jt
from projects.mmdet3d_plugin.jittor_adapter import BBOX_ASSIGNERS, build_match_cost
    ...
    def assign(self,
        ...
        Args:
            ...
            cls_pred (Var): Predicted classification logits, shape
                [num_query, num_class].
            gt_bboxes (Var): Ground truth boxes with unnormalized
                coordinates (x1, y1, x2, y2). Shape [num_gt, 4].
            gt_labels (Var): Label of `gt_bboxes`, shape (num_gt,).
            gt_bboxes_ignore (Var, optional): Ground truth bboxes that are
        ...
        assigned_gt_inds = jt.full((num_bboxes, ),
                                              -1,
                                              dtype='int32')
        ...
        matched_row_inds = jt.array(matched_row_inds)
        matched_col_inds = jt.array(matched_col_inds)
